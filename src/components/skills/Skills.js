...
let skillsList = [
  {
    ...
    skillDesc:"I am proficient in HTML, CSS, JavaScript, TypeScript, React, Angular, and Android development, creating dynamic and responsive interfaces.",
  },
  {
    id: 2,
    image: backend,
    skillHeading: "Backend Development",
    skillDesc:"I am experienced in Node.js, Java, PHP, and NestJS for building scalable backend systems, with expertise in Spring, Spring Boot, and Spring MVC for exposing REST APIs.",
  },
  {
    id: 3,
    image: database,
    skillHeading: "Database Management",
    skillDesc:"Skilled in MySQL, PostgreSQL, MongoDB, and MongoDB Atlas for efficient data storage and retrieval.",
  },
  {
    id: 4,
    image: api,
